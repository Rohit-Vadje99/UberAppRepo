...
public class RiderDto {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RiderDto)) return false;
        final RiderDto other = (RiderDto) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RiderDto;
    }
    ...
    public String toString() {
        return "RiderDto(user=" + this.getUser() + ", rating=" + this.getRating() + ")";
    }
}
